...
imgContours, imgHierarchy = cv2.findContours(grayImg,cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
imgRect = cv2.rectangle(grayImg,(0,0),(grayImg.shape[0]-1,grayImg.shape[1]-1),(255,0,0))
